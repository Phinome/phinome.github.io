<h1 id="Glob">Glob</h1><p>This is a glob implementation in JavaScript.  It uses the <code>minimatch</code><br>library to do its matching.</p>
<h2 id="Attention:_node-glob_users!">Attention: node-glob users!</h2><p>The API has changed dramatically between 2.x and 3.x. This library is<br>now 100% JavaScript, and the integer flags have been replaced with an<br>options object.</p>
...
<h2 id="Features">Features</h2><p>Please see the <a href="https://github.com/isaacs/minimatch">minimatch<br>documentation</a> for more details.</p>
...
<h2 id="Class:_glob-Glob">Class: glob.Glob</h2><p>Create a Glob object by instanting the <code>glob.Glob</code> class.</p>
