<h1 id="lru_cache">lru cache</h1><p>A cache object that deletes the least-recently-used items.</p>
<h2 id="Usage:">Usage:</h2><pre><code class="javascript"><span class="keyword">var</span> LRU = <span class="built_in">require</span>(<span class="string">"lru-cache"</span>)
