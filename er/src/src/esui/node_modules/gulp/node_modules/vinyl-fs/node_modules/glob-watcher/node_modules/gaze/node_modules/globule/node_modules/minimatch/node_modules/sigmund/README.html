<h1 id="sigmund">sigmund</h1><p>Quick and dirty signatures for Objects.</p>
...
<h2 id="Usage">Usage</h2><pre><code class="javascript"><span class="function"><span class="keyword">function</span> <span class="title">doSomething</span> (<span class="params">someObj</span>) </span>{
...
<p>Also, just as there is no way to summon the soul from the scribblings<br>of a cocain-addled psychoanalyst, there is no way to revive the object<br>from the signature string that sigmund gives you.  In fact, it’s<br>barely even readable.</p>
<p>As with <code>sys.inspect</code> and <code>JSON.stringify</code>, larger objects will<br>produce larger signature strings.</p>
...
<pre><code>var obj1 = {<span class="string">a:</span><span class="string">'b'</span>,<span class="string">c:</span><span class="regexp">/def/</span>,<span class="string">g:</span>[<span class="string">'h'</span>,<span class="string">'i'</span>,{<span class="string">j:</span><span class="string">''</span>,<span class="string">k:</span><span class="string">'l'</span>}]}
var obj2 = {<span class="string">a:</span><span class="string">'b'</span>,<span class="string">c:</span><span class="string">'/def/'</span>,<span class="string">g:</span>[<span class="string">'h'</span>,<span class="string">'i'</span>,<span class="string">'{jkl'</span>]}
