...
<h3 id="nonull">nonull</h3><p>When a match is not found by <code>minimatch.match</code>, return a list containing<br>the pattern itself.  When set, an empty list is returned if there are<br>no matches.</p>
