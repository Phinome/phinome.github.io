...
<pre><code class="js">gulp.src(<span class="string">'lib/*.js'</span>)
  .pipe(uglify())
  .pipe(gulp.src(<span class="string">'styles/*.css'</span>))
  .pipe(gulp.dest(<span class="function"><span class="keyword">function</span>(<span class="params">file</span>)</span>{
    <span class="comment">// I don't know, you can do something cool here</span>
    <span class="keyword">return</span> <span class="string">'build/whatever'</span>;
  }));
</code></pre>
<h2 id="3-7-0">3.7.0</h2><ul>
...
<h2 id="3-3-4">3.3.4</h2><ul>
<li><code>--base</code> is now <code>--cwd</code></li>
</ul>
<h2 id="3-3-3">3.3.3</h2><ul>
...
<h2 id="3-2-4">3.2.4</h2><ul>
<li>Bug fix - we didn’t have any CLI tests</li>
</ul>
<h2 id="3-2-3">3.2.3</h2><ul>
...
<h2 id="1-2-2-4_(11/12/13)">1.2-2.4 (11/12/13)</h2><ul>
...
<h2 id="1-2_(10/28/13)">1.2 (10/28/13)</h2><ul>
...
<h2 id="1-1_(10/21/13)">1.1 (10/21/13)</h2><ul>
...
<h2 id="1-0_(9/26/13)">1.0 (9/26/13)</h2><ul>
<li>Specify dependency versions</li>
<li>Updated docs</li>
</ul>
<h2 id="0-2_(8/6/13)">0.2 (8/6/13)</h2><ul>
<li>Rename .files() to .src() and .folder() to .dest()</li>
</ul>
<h2 id="0-1_(7/18/13)">0.1 (7/18/13)</h2><ul>
