...
<h2 id="Command_Line_Interface">Command Line Interface</h2><p>To use the executable, it’s probably best to install this library globally.</p>
<p><code>npm install -g node-uuid</code></p>
<p>Usage:</p>
<pre><code><span class="attribute">USAGE</span>: <span class="string">uuid [version] [options]</span>

<span class="vim">
option<span class="variable">s:</span>

--<span class="keyword">help</span>                     Display this message <span class="built_in">and</span> <span class="keyword">exit</span></span>
...
<h3 id="Examples">Examples</h3><pre><code><span class="blockquote">&gt; uuid</span>
3a91f950-dec8-4688-ba14-5b7bbfc7a563
</code></pre><pre><code>&gt; uuid v1
<span class="number">9d0b43e0</span>-<span class="number">7696-11e3</span>-964b-250efa37a98e
</code></pre><pre><code>&gt; uuid v4
<span class="number">6790</span>ac7c-<span class="number">24</span>ac-<span class="number">4f</span>98-<span class="number">8464</span>-<span class="number">42f</span>6d98a53ae
</code></pre><h2 id="Testing">Testing</h2><p>In node.js</p>
...
node <span class="keyword">benchmark</span>/<span class="keyword">benchmark</span>.js</span>
...
<h2 id="Release_notes">Release notes</h2><h3 id="1-4-0">1.4.0</h3><ul>
<li>Improved module context detection</li>
<li>Removed public RNG functions</li>
</ul>
<h3 id="1-3-2">1.3.2</h3><ul>
